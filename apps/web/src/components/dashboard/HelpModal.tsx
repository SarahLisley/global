  ...
  return createPortal(
    <>
      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
        ...
        >
          {/* Header */}
          <div className="px-6 py-4 border-b border-gray-100 dark:border-zinc-800 flex items-center justify-between bg-gradient-to-r from-gray-50 dark:from-zinc-900 to-white dark:to-zinc-800">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-blue-50 dark:bg-blue-900/30 rounded-lg text-[#4a90e2] dark:text-blue-400">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-3">
              <div className="p-4 bg-gray-50 dark:bg-zinc-800/50 rounded-xl border border-gray-100 dark:border-zinc-800 flex items-center gap-4 group hover:border-blue-200 dark:hover:border-blue-800/50 transition-colors">
                <div className="p-2 bg-white dark:bg-zinc-800 rounded-lg shadow-sm text-gray-600 dark:text-zinc-400 group-hover:text-[#4a90e2] dark:group-hover:text-blue-400 transition-colors">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
