  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-zinc-100">Financeiro</h1>
          <p className="text-slate-500 dark:text-zinc-400 mt-1">Gerencie seus títulos, boletos e histórico financeiro.</p>
        </div>
      </div>
      ...
      <Card className="p-0 overflow-hidden border-slate-200 dark:border-zinc-800 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              ...
              <div className="flex items-center gap-4 px-1 pt-1">
                <label className="flex items-center gap-2 cursor-pointer group">
                  <input
                    ...
                    className="w-4 h-4 text-blue-600 dark:text-blue-500 border-slate-300 dark:border-zinc-700 focus:ring-blue-500 cursor-pointer"
                  />
                ...
                <label className="flex items-center gap-2 cursor-pointer group">
                  <input
                    ...
                    className="w-4 h-4 text-green-600 border-slate-300 dark:border-zinc-700 focus:ring-green-500 cursor-pointer"
                  />
                  <span className="text-sm text-slate-600 dark:text-zinc-400 group-hover:text-slate-900 dark:text-zinc-100 transition-colors">Pagos</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer group">
                  <input
                    type="radio"
                    ...
                    className="w-4 h-4 text-red-600 dark:text-red-500 border-slate-300 dark:border-zinc-700 focus:ring-red-500 cursor-pointer"
                  />
                  <span className="text-sm text-slate-600 dark:text-zinc-400 group-hover:text-slate-900 dark:text-zinc-100 transition-colors">Não Pagos</span>
                </label>
              </div>
            </div>
            ...
            <div className="md:col-span-7 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white dark:bg-zinc-900 rounded-lg p-1 border border-slate-200 dark:border-zinc-800 shadow-sm focus-within:border-blue-500 transition-all">
                  <label htmlFor="numped" className="block text-[10px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-wider px-2 pt-1">Pedido</label>
                  <input
                    id="numped"
                    type="text"
                ...
                <div className="bg-white dark:bg-zinc-900 rounded-lg p-1 border border-slate-200 dark:border-zinc-800 shadow-sm focus-within:border-blue-500 transition-all">
                  <label htmlFor="notaFiscal" className="block text-[10px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-wider px-2 pt-1">Nota Fiscal</label>
                  <input
                    id="notaFiscal"
                    type="text"
        ...
        {initialTitulos.length === 0 ? (
          <div className="p-12 text-center flex flex-col items-center justify-center">
            ...
            <h3 className="text-lg font-medium text-slate-900 dark:text-zinc-100">Nenhum título encontrado</h3>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm text-slate-600 dark:text-zinc-400">
                <thead className="bg-slate-50 dark:bg-zinc-900/40 border-b border-slate-200 dark:border-zinc-800">
                  <tr>
                    <th className="px-6 py-4 font-bold text-slate-800 dark:text-zinc-200 whitespace-nowrap text-xs uppercase tracking-wider">Documento</th>
                    <th className="px-6 py-4 font-bold text-slate-800 dark:text-zinc-200 whitespace-nowrap text-xs uppercase tracking-wider text-center">Parcela</th>
                    <th className="px-6 py-4 font-bold text-slate-800 dark:text-zinc-200 whitespace-nowrap text-xs uppercase tracking-wider">Emissão</th>
                    <th className="px-6 py-4 font-bold text-slate-800 dark:text-zinc-200 whitespace-nowrap text-xs uppercase tracking-wider">Vencimento</th>
                    <th className="px-6 py-4 font-bold text-slate-800 dark:text-zinc-200 whitespace-nowrap text-xs uppercase tracking-wider">Valor</th>
                    <th className="px-6 py-4 font-bold text-slate-800 dark:text-zinc-200 whitespace-nowrap text-xs uppercase tracking-wider">Cobrança</th>
                    <th className="px-6 py-4 font-bold text-slate-800 dark:text-zinc-200 whitespace-nowrap text-xs uppercase tracking-wider">Status</th>
                    <th className="px-6 py-4 font-bold text-slate-800 dark:text-zinc-200 whitespace-nowrap text-xs uppercase tracking-wider">Ações</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100 dark:divide-zinc-800/50">
                  {initialTitulos.map((t) => {
                    ...
                    return (
                      <tr key={t.id} className="group hover:bg-slate-50 dark:hover:bg-zinc-800/50 dark:bg-zinc-900/40 transition-colors duration-200">
                        <td className="px-6 py-5">
                          <div className="font-semibold text-slate-900 dark:text-zinc-100 text-[15px]">{t.nroDocto}</div>
                          <div className="flex items-center gap-2 mt-1.5 text-xs text-slate-500 dark:text-zinc-400">
                            {t.numped && (
                              <span title="Número do Pedido">Ped. {t.numped}</span>
                            )}
                            {t.numped && t.notaFiscal && <span className="text-slate-300 dark:text-zinc-600">•</span>}
                            {t.notaFiscal && (
                              <span title="Nota Fiscal">NF {t.notaFiscal}</span>
                            )}
                          </div>
                        </td>
                        <td className="px-6 py-5 text-slate-700 dark:text-zinc-300 font-medium text-center">{t.parcela}</td>
                        <td className="px-6 py-5 whitespace-nowrap text-slate-600 dark:text-zinc-400">{fmtBR.format(new Date(t.dtEmissao))}</td>
                        <td className="px-6 py-5 whitespace-nowrap">
                          <div className={vencido && !t.dtPgto ? "font-medium text-red-600 dark:text-red-500 flex items-center gap-1.5" : "text-slate-600 dark:text-zinc-400"}>
                        ...
                        <td className="px-6 py-5">
                          <div className="font-semibold text-slate-700 dark:text-zinc-300 text-sm">{fmtBRL.format(t.valor)}</div>
                          {t.jurosTaxas > 0 && (
                            <div className="text-xs text-red-600 dark:text-red-500 mt-1 font-semibold bg-red-50 dark:bg-red-950/30 px-2 py-0.5 rounded-md w-fit">
                              +{fmtBRL.format(t.jurosTaxas)} juros
                            </div>
                          )}
                        </td>
                        <td className="px-6 py-5">
                          <Badge variant="outline" className="font-medium bg-slate-50 dark:bg-zinc-900/40 text-slate-700 dark:text-zinc-300 border-slate-300 dark:border-zinc-700 shadow-sm">
                            {t.cobranca}
                          </Badge>
                        </td>
                        <td className="px-6 py-5">
                        ...
                        <td className="px-6 py-5">
                          <div className="flex flex-col gap-2">
                            {t.boletoUrl ? (
                              ...
                              <button
                                disabled
                                className="inline-flex items-center gap-2 text-slate-400 dark:text-zinc-500 bg-slate-50 dark:bg-zinc-900/40 border border-slate-100 dark:border-zinc-800/50 px-3 py-1.5 rounded-md text-xs font-medium cursor-not-allowed"
                            ...
                            {(t.linhaDigitavel || t.codigoBarras) ? (
                              <button
                                ...
                                className="inline-flex items-center gap-2 text-slate-600 dark:text-zinc-400 hover:text-green-600 bg-white dark:bg-zinc-900 hover:bg-slate-50 dark:hover:bg-zinc-800/50 dark:bg-zinc-900/40 border border-slate-200 dark:border-zinc-800 hover:border-green-200 px-3 py-1.5 rounded-md text-xs font-medium transition-colors"
