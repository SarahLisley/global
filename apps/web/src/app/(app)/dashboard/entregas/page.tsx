      ...
      <Card className="p-0 overflow-hidden border-slate-200 shadow-sm">
        ...
        {loading ? (
          <div className="p-12 text-center flex flex-col items-center justify-center">
            ...
            <h3 className="text-lg font-medium text-slate-900">Carregando entregas...</h3>
          </div>
                  ...
                  <tr key={e.id} className="hover:bg-blue-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      {e.status === 'Entregue' ? (
                        ...
                        <Badge variant="info" className="gap-1.5 pl-1.5 pr-2.5">
                        ...
                        <Badge className="gap-1.5 pl-1.5 pr-2.5">
                          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            <rect x="3" y="4" width="18" height="18" rx="2" ry="2" />
                            <line x1="16" y1="2" x2="16" y2="6" />
                            <line x1="8" y1="2" x2="8" y2="6" />
                    ...
                    <td className="px-6 py-4">
                      <button
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-blue-50 text-blue-700 hover:bg-blue-100 hover:text-blue-800 font-medium text-sm transition-all hover:shadow-sm"
