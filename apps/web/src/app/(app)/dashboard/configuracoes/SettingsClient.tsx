    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-72 flex-shrink-0">
          <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-gray-100 p-2">
        ...
        <div className="flex-1">
          <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-gray-100 p-8 min-h-[500px]">
            {activeTab === 'perfil' && (
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  <FormField label="Nome Completo">
                    <Input
                      ...
                      className="bg-gray-50 border-gray-200 text-gray-900 focus:bg-white dark:bg-zinc-900 transition-colors h-11"
                    />
                  </FormField>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-5 bg-gray-50 rounded-xl hover:bg-gray-100/80 transition-colors cursor-pointer" onClick={() => setFormData(prev => ({ ...prev, notificacoesEmail: !prev.notificacoesEmail }))}>
                    <div className="flex items-center gap-4">
                      <div className="p-2 bg-white dark:bg-zinc-900 rounded-lg text-blue-600 dark:text-blue-500 shadow-sm">
                    ...
                    <div className={clsx(
                      ...
                      <div className={clsx(
                        "w-5 h-5 bg-white dark:bg-zinc-900 rounded-full absolute top-1 transition-all shadow-sm",
            ...
            <div className="mt-10 pt-6 border-t border-gray-100 flex items-center justify-between gap-3 sticky bottom-0 bg-white/95 backdrop-blur-sm p-4 -mx-8 -mb-8 rounded-b-2xl">
              {saveMessage && (
                <p className={clsx(
                  'text-sm font-medium',
                  saveMessage.type === 'success' ? 'text-emerald-600 dark:text-emerald-500' : 'text-red-600 dark:text-red-500'
                )}>
                  {saveMessage.text}
                </p>
              )}
